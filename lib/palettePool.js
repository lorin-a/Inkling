...
export const POOLS = {
  starred: [], // hydrated client-side from /api/library/palette
  brand: brandSwatches,
  curated: dedupe(Object.values(curatedGroups).flat()),
  all: allUnique,
  // `moodboard` is hydrated client-side from /api/library/palette inside
  // usePalette. Empty until you've extracted from at least one pin.
  moodboard: [],
};
