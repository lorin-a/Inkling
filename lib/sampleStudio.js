...
export const SAMPLE_PROJECT = {
  ...
  period: ".",
  initial: "Y",
  tagline: "A working title for the identity you’re about to build.",
  body:
    "This is a sample studio. Rename it, recolor it, or import your own " +
    "Pinterest board to make it yours.",
  fonts: {},
};
