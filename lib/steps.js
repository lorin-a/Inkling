...
export const STEPS = [
  ...
  { href: "/gradients", n: "06", verb: "Surface",  title: "Gradients",        body: "Sketch linear / radial / conic gradients from any project color. Drag the angle, drag the stops, copy the CSS." },
