...
| 103 | "We need to be more intentional with the first words. Make it more of a generative exercise. More generative questions, showcase overlap, offer thesaurus, study your best design thinking approach to this. something like when people encounter the brand they will immediately feel ______, the most memorable part of the brand is that ______, the brand will evoke feelings of _______, The brand is respected by _______, things like that where you think outside the box and the answers translate to color theory, type choice, design systems, imagery etc. And since this is collaborative how would we design the overlap between partners, some kind of concentric circles diagram? draggable words? something like those refrigerator magnets where you can make it into a new string of sentences? brainstorm first" | **Open — 2026-09-06.** Brainstorm delivered in the session reply (prompts as sentence starters; words as magnets; the overlap as a shared table where matching words pull together; a lexicon that reads chosen words into color, type and imagery leanings). Awaiting her direction before building. |
